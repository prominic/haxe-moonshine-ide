 ...
 *  Class:      StatusTextInputSkin
 *  Source:     /Users/axgord/dev/Moonshine-IDE/ide/MoonshineSharedCore/src/actionScripts/plugin/findreplace/view/StatusTextInputSkin.mxml
...
//  begin class def
class StatusTextInputSkin extends spark.components.supportClasses.Skin implements mx.binding.IBindingClient implements mx.core.IStateClient2 {
	 ...
	 * @private
	 **/
	public var statusView:spark.components.RichText;
	...
	public function new() {
		...
		var bindings:Array<Dynamic> = _StatusTextInputSkin_bindingsSetup();
		var watchers:Array<Dynamic> = [];

		var target:Dynamic = this;

		if (_watcherSetupUtil == null) {
			var watcherSetupUtilClass:Dynamic = Type.resolveClass('_actionScripts_plugin_findreplace_view_StatusTextInputSkinWatcherSetupUtil');
		...
		_watcherSetupUtil.setup(this,
				...
				function(propertyName:String):Dynamic {
					return Reflect.getProperty(StatusTextInputSkin, propertyName);
				},
				bindings,
				watchers
		);
		...
		this.mxmlContent = [_StatusTextInputSkin_Rect1_i(), _StatusTextInputSkin_RichEditableText1_i(), _StatusTextInputSkin_RichText1_i(), _StatusTextInputSkin_RichText2_i()];
	...
	private function _StatusTextInputSkin_Rect1_i():spark.primitives.Rect {
		...
		temp.bottom = 0;
		temp.height = 18;
		temp.stroke = _StatusTextInputSkin_SolidColorStroke1_i();
		temp.fill = _StatusTextInputSkin_SolidColor1_i();
	...
	private function _StatusTextInputSkin_SolidColorStroke1_i():mx.graphics.SolidColorStroke {
	...
	private function _StatusTextInputSkin_SolidColor1_i():mx.graphics.SolidColor {
	...
	private function _StatusTextInputSkin_RichEditableText1_i():spark.components.RichEditableText {
	...
	private function _StatusTextInputSkin_RichText1_i():spark.components.RichText {
	...
	private function _StatusTextInputSkin_RichText2_i():spark.components.RichText {
		var temp:spark.components.RichText = new spark.components.RichText();
		temp.mouseEnabled = false;
		temp.mouseChildren = false;
		temp.right = 4;
		...
		statusView = temp;
		mx.binding.BindingManager.executeBindings(this, 'statusView', statusView);
		return temp;
	}

	//  binding mgmt
	private function _StatusTextInputSkin_bindingsSetup():Array<Dynamic> {
		var result:Array<Dynamic> = [];

		result[0] = new mx.binding.Binding(this,
				function():Dynamic {
					return (8 + statusView.width);
				},
				null,
				'textDisplay.right');
		...
		result[2] = new mx.binding.Binding(this,
				...
				function(_sourceFunctionReturnValue:Int):Void {
					statusView.setStyle('color', _sourceFunctionReturnValue);
				},
				'statusView.color');
	...
	private static function set_watcherSetupUtil(watcherSetupUtil:IWatcherSetupUtil2):IWatcherSetupUtil2 {
		(StatusTextInputSkin)._watcherSetupUtil = watcherSetupUtil;
