 ...
 *  Source:     /Users/axgord/dev/Moonshine-IDE/ide/MoonshineSharedCore/src/components/views/project/ProjectListItemRenderer.mxml
...
class ProjectListItemRenderer extends spark.components.supportClasses.ItemRenderer implements mx.binding.IBindingClient {
	...
	public function new() {
		...
		if (_watcherSetupUtil == null) {
			var watcherSetupUtilClass:Dynamic = Type.resolveClass('_components_views_project_ProjectListItemRendererWatcherSetupUtil');
		...
		// properties
		this.minHeight = 25;
		this.layout = _ProjectListItemRenderer_HorizontalLayout1_c();
		this.mxmlContent = [_ProjectListItemRenderer_Label1_i(), _ProjectListItemRenderer_Image1_i()];
	...
	private function _ProjectListItemRenderer_HorizontalLayout1_c():spark.layouts.HorizontalLayout {
