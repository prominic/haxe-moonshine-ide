 ...
 *  Class:      TabBarButtonSkin
 *  Source:     /Users/axgord/dev/Moonshine-IDE/ide/MoonshineSharedCore/src/components/skins/TabBarButtonSkin.mxml
...
//  begin class def
class TabBarButtonSkin extends spark.skins.SparkButtonSkin implements mx.core.IStateClient2 {
	 ...
	 * @private
	 **/
	public var _TabBarButtonSkin_GradientEntry1:mx.graphics.GradientEntry;
	 ...
	 * @private
	 **/
	public var _TabBarButtonSkin_GradientEntry2:mx.graphics.GradientEntry;
	 ...
	 * @private
	 **/
	public var _TabBarButtonSkin_SolidColor1:mx.graphics.SolidColor;
	 ...
	 * @private
	 **/
	public var _TabBarButtonSkin_SolidColorStroke1:mx.graphics.SolidColorStroke;
	 ...
	 * @private
	 **/
	public var closeTabButton:actionScripts.ui.tabNavigator.CloseTabButton;
	...
	public function new() {
		...
		this.minWidth = 21;
		this.minHeight = 21;
		this.mxmlContent = [_TabBarButtonSkin_Rect1_i(), _TabBarButtonSkin_Line1_i(), _TabBarButtonSkin_Path1_i(), _TabBarButtonSkin_Label1_i(), _TabBarButtonSkin_CloseTabButton1_i()];
	...
	private function updateCloseButton():Void {
		var buttonBarButton:ButtonBarButton = AS3.as(this.hostComponent, ButtonBarButton);
		closeTabButton.visible = closeTabButton.includeInLayout = getStyle('closeButtonVisible') && buttonBarButton.itemIndex > 0;
		if (!AS3.as(closeTabButton.visible, Bool)) {
			(AS3.as(labelDisplay, Label)).right = 10;
		}
	}
	...
	private function _TabBarButtonSkin_Rect1_i():spark.primitives.Rect {
		...
		temp.width = 70;
		temp.height = 22;
		temp.fill = _TabBarButtonSkin_SolidColor1_i();
	...
	private function _TabBarButtonSkin_SolidColor1_i():mx.graphics.SolidColor {
		var temp:mx.graphics.SolidColor = new mx.graphics.SolidColor();
		temp.color = 4342338;
		_TabBarButtonSkin_SolidColor1 = temp;
		mx.binding.BindingManager.executeBindings(this, '_TabBarButtonSkin_SolidColor1', _TabBarButtonSkin_SolidColor1);
		return temp;
	}

	private function _TabBarButtonSkin_Line1_i():spark.primitives.Line {
		var temp:spark.primitives.Line = new spark.primitives.Line();
		temp.left = 0;
		temp.right = 0;
		temp.bottom = 0;
		temp.stroke = _TabBarButtonSkin_SolidColorStroke1_i();
	...
	private function _TabBarButtonSkin_SolidColorStroke1_i():mx.graphics.SolidColorStroke {
		var temp:mx.graphics.SolidColorStroke = new mx.graphics.SolidColorStroke();
		temp.weight = 1;
		temp.color = 13619151;
		temp.alpha = 0.75;
		_TabBarButtonSkin_SolidColorStroke1 = temp;
		mx.binding.BindingManager.executeBindings(this, '_TabBarButtonSkin_SolidColorStroke1', _TabBarButtonSkin_SolidColorStroke1);
		return temp;
	}

	private function _TabBarButtonSkin_Path1_i():spark.primitives.Path {
		...
		temp.stroke = _TabBarButtonSkin_LinearGradientStroke1_c();
	...
	private function _TabBarButtonSkin_LinearGradientStroke1_c():mx.graphics.LinearGradientStroke {
		var temp:mx.graphics.LinearGradientStroke = new mx.graphics.LinearGradientStroke();
		temp.rotation = 90;
		temp.weight = 1;
		temp.entries = [_TabBarButtonSkin_GradientEntry1_i(), _TabBarButtonSkin_GradientEntry2_i()];
		return temp;
	}

	private function _TabBarButtonSkin_GradientEntry1_i():mx.graphics.GradientEntry {
		var temp:mx.graphics.GradientEntry = new mx.graphics.GradientEntry();
		temp.color = 13619151;
		temp.alpha = 0.5625;
		_TabBarButtonSkin_GradientEntry1 = temp;
		mx.binding.BindingManager.executeBindings(this, '_TabBarButtonSkin_GradientEntry1', _TabBarButtonSkin_GradientEntry1);
		return temp;
	}

	private function _TabBarButtonSkin_GradientEntry2_i():mx.graphics.GradientEntry {
		var temp:mx.graphics.GradientEntry = new mx.graphics.GradientEntry();
		temp.color = 13619151;
		temp.alpha = 0.75;
		_TabBarButtonSkin_GradientEntry2 = temp;
		mx.binding.BindingManager.executeBindings(this, '_TabBarButtonSkin_GradientEntry2', _TabBarButtonSkin_GradientEntry2);
		return temp;
	}

	private function _TabBarButtonSkin_Label1_i():spark.components.Label {
	...
	private function _TabBarButtonSkin_CloseTabButton1_i():actionScripts.ui.tabNavigator.CloseTabButton {
		var temp:actionScripts.ui.tabNavigator.CloseTabButton = new actionScripts.ui.tabNavigator.CloseTabButton();
		temp.width = 27;
		temp.height = 25;
		temp.right = 0;
		temp.top = 0;
		temp.bottom = 0;
		temp.verticalCenter = 0;
		temp.id = 'closeTabButton';
		if (!AS3.as(temp.document, Bool)) {
			temp.document = this;
		}
		closeTabButton = temp;
		mx.binding.BindingManager.executeBindings(this, 'closeTabButton', closeTabButton);
		return temp;
	}
