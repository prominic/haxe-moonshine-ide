 ...
 *  Class:      TransparentTextAreaSkin
 *  Source:     /Users/axgord/dev/Moonshine-IDE/ide/MoonshineSharedCore/src/components/skins/TransparentTextAreaSkin.mxml
...
//  begin class def
class TransparentTextAreaSkin extends spark.skins.SparkSkin implements mx.core.IStateClient2 {
	...
	public function new() {
		...
		this.mxmlContent = [_TransparentTextAreaSkin_Rect1_i(), _TransparentTextAreaSkin_Rect2_i(), _TransparentTextAreaSkin_Rect3_i(), _TransparentTextAreaSkin_Scroller1_i()];
		this.currentState = 'normal';

		// events

		var _TransparentTextAreaSkin_Label1_factory:DeferredInstanceFromFunction =
		new mx.core.DeferredInstanceFromFunction(_TransparentTextAreaSkin_Label1_i);
		...
		states = [
				...
				new State({
					...
					new AddItems().initializeFromObject({
								'itemsFactory': _TransparentTextAreaSkin_Label1_factory,
								'destination': null,
	...
	private function _TransparentTextAreaSkin_Rect1_i():spark.primitives.Rect {
		var temp:spark.primitives.Rect = new spark.primitives.Rect();
		temp.left = 0;
		temp.right = 0;
		temp.top = 0;
		temp.bottom = 0;
		temp.stroke = _TransparentTextAreaSkin_SolidColorStroke1_i();
	...
	private function _TransparentTextAreaSkin_SolidColorStroke1_i():mx.graphics.SolidColorStroke {
	...
	private function _TransparentTextAreaSkin_Rect2_i():spark.primitives.Rect {
		var temp:spark.primitives.Rect = new spark.primitives.Rect();
		temp.left = 1;
		temp.right = 1;
		temp.top = 1;
		temp.bottom = 1;
		temp.fill = _TransparentTextAreaSkin_SolidColor1_i();
	...
	private function _TransparentTextAreaSkin_SolidColor1_i():mx.graphics.SolidColor {
	...
	private function _TransparentTextAreaSkin_Rect3_i():spark.primitives.Rect {
		var temp:spark.primitives.Rect = new spark.primitives.Rect();
		temp.left = 1;
		temp.top = 1;
		temp.right = 1;
		temp.height = 1;
		temp.fill = _TransparentTextAreaSkin_SolidColor2_c();
	...
	private function _TransparentTextAreaSkin_SolidColor2_c():mx.graphics.SolidColor {
		var temp:mx.graphics.SolidColor = new mx.graphics.SolidColor();
		temp.color = 0;
		temp.alpha = 0.12;
		return temp;
	...
	private function _TransparentTextAreaSkin_Scroller1_i():spark.components.Scroller {
		...
		temp.viewport = _TransparentTextAreaSkin_RichEditableText1_i();
		temp.id = 'scroller';
	...
	private function _TransparentTextAreaSkin_RichEditableText1_i():spark.components.RichEditableText {
	...
	private function _TransparentTextAreaSkin_Label1_i():spark.components.Label {
