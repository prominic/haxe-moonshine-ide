...
class RenameFile {
	...
	public static inline var KIND:String = 'rename';

	/**
	 * The kind of file operation.
	 */
	public var kind(default, never):String = KIND;
	...
	public static function parse(original:Dynamic):RenameFile {
		...
		vo.oldUri = AS3.string(Reflect.field(original, 'oldUri'));
		vo.newUri = AS3.string(Reflect.field(original, 'newUri'));
		return vo;
	}
