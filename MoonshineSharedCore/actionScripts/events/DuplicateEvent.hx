...
class DuplicateEvent extends Event {
	...
	public static inline var EVENT_APPLY_DUPLICATE:String = 'applyDuplicate';
	public static inline var EVENT_OPEN_DUPLICATE_FILE_VIEW:String = 'openDuplicateFileView';
