...
class TemplatingEvent extends Event {
	...
	public static inline var ADDED_NEW_TEMPLATE:String = 'ADDED_NEW_TEMPLATE';
	public static inline var REMOVE_TEMPLATE:String = 'REMOVE_TEMPLATE';
	public static inline var RENAME_TEMPLATE:String = 'RENAME_TEMPLATE';
