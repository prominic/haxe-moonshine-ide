...
class TemplateSetting extends AbstractSetting {

	private var rdr:TemplateRenderer = new TemplateRenderer();
	...
	public function new(originalTemplate:FileLocation, customTemplate:FileLocation, label:String) {
		super();
		this.provider = this;
