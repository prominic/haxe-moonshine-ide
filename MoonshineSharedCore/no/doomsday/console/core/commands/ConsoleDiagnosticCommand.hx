 ...
 */
class ConsoleDiagnosticCommand extends ConsoleCommand {

	public var dictionary:haxe.ds.ObjectMap<Dynamic, Dynamic>;
	 ...
	 */
	public function new(trigger:String, objects:Array<Dynamic>, grouping:String = 'Application', helpText:String = '') {
		super(trigger);
		this.dictionary = new Dictionary(true);
		this.grouping = grouping;
		this.helpText = helpText;
		for (i in 0...objects.length) {
			dictionary.set('o' + i, objects[i]);
		}
	}
