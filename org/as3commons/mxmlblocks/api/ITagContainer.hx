...
interface ITagContainer {
	 ...
	 */
	var hasChildren(get, never):Bool;
	 ...
	 */
	var namespaces(get, never):Array<IXMLNamespace>;
	 ...
	 */
	var attributes(get, never):Array<IAttribute>;
	 ...
	 * The tag's children.
	 */
	var children(get, never):Array<ITag>;
