...
class TokenListUpdateDelegate implements ITokenListUpdateDelegate {
	...
	private function isPlaceholder(ast:IParserNode):Bool {
		return ast.startToken == ast.stopToken && ast.startToken != null && ast.startToken.kind == 'virtual-placeholder' && cast((ast.startToken), PlaceholderLinkedListToken).held == ast;
	}
