 ...
 * @productversion 1.0
 */
class ForLabelStatementNode extends LabelStatementNode implements IForLabelStatement {

	public var statement(get, never):IForStatement;
	 ...
	 * doc
	 */
	private function get_statement():IForStatement {
