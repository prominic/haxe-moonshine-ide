 ...
 * @productversion 1.0
 */
class ObjectLiteralNode extends LiteralNode implements IObjectLiteral {

	public var fields(get, never):Array<IPropertyField>;
	 ...
	 */
	private function get_fields():Array<IPropertyField> {
		var result:Array<IPropertyField> = new Array<IPropertyField>();
