 ...
 */
interface IASProject extends IEventDispatcher {
	 ...
	 * @since 1.0
	 */
	var factory(get, never):ASFactory;
	 ...
	 * @since 1.0
	 */
	var compilationUnits(get, never):Array<ICompilationUnit>;
	 ...
	 * @since 1.0
	 */
	var classPathEntries(get, never):Array<IClassPathEntry>;
	 ...
	 * @since 1.0
	 */
	var resourceRoots(get, never):Array<IResourceRoot>;
	 ...
	 * @since 1.0
	 */
	var outputLocation(get, set):String;
	 ...
	 * @since 1.0
	 */
	function addCompilationUnit(unit:ICompilationUnit):Bool;
	 ...
	 * @since 1.0
	 */
	function removeCompilationUnit(unit:ICompilationUnit):Bool;
	 ...
	 * @since 1.0
	 */
	function removeClassPath(classPath:String):Bool;
	 ...
	 * @since 1.0
	 */
	function addResourceRoot(resource:IResourceRoot):Bool;
	 ...
	 * @since 1.0
	 */
	function removeResourceRoot(resource:IResourceRoot):Bool;
