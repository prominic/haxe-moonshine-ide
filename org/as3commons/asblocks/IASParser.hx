...
interface IASParser {
	...
	function parseAsync(sourceCode:ISourceCode,
			...
			parseBlocks:Bool = true):IParserInfo;
	 ...
	 * @since 1.0
	 */
	function parse(sourceCode:ISourceCode, parseBlocks:Bool = true):ICompilationUnit;
	 ...
	 * @since 1.0
	 */
	function parseString(sourceCode:String, parseBlocks:Bool = true):ICompilationUnit;
