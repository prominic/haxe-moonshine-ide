...
class MetaDataUtil {
	...
	public static function getMetaDatas(ast:IParserNode):Array<IMetaData> {
		var result:Array<IMetaData> = new Array<IMetaData>();
	...
	public static function getAllMetaData(ast:IParserNode, name:String):Array<IMetaData> {
		var result:Array<IMetaData> = new Array<IMetaData>();
	...
	public static function hasMetaData(ast:IParserNode, name:String):Bool {
		var list:IParserNode = findMetaList(ast);
		if (list == null) {
			return false;
		}
	...
	public static function removeMetaData(ast:IParserNode, metaData:IMetaData):Bool {
		var list:IParserNode = findMetaList(ast);
		if (list == null) {
			return false;
		}
