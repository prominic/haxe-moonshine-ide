...
interface IMetaDataAware {
	 ...
	 */
	var metaDatas(get, never):Array<IMetaData>;
	 ...
	 */
	function getAllMetaData(name:String):Array<IMetaData>;
	 ...
	 */
	function hasMetaData(name:String):Bool;
	 ...
	 */
	function removeMetaData(metaData:IMetaData):Bool;
