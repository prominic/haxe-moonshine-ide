 ...
 */
interface IInterfaceType extends IType extends IContentBlock {
	 ...
	 */
	var superInterfaces(get, never):Array<String>;
	 ...
	 */
	var qualifiedSuperInterfaces(get, never):Array<String>;
	 ...
	 */
	function addSuperInterface(name:String):Bool;
	 ...
	 */
	function removeSuperInterface(name:String):Bool;
