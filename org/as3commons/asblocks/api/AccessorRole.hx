...
@:final class AccessorRole {
	 ...
	 */
	public static var NORMAL:AccessorRole = AccessorRole.create('normal');

	/**
	 * A function using the normal <code>function [get]</code> keyword.
	 */
	public static var GETTER:AccessorRole = AccessorRole.create('getter');

	/**
	 * A function using the normal <code>function [set]</code> keyword.
	 */
	public static var SETTER:AccessorRole = AccessorRole.create('setter');
