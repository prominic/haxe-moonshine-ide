...
class LoadVariablesEvent extends Event {

	public static inline var LOAD_VARIABLES:String = 'loadVariables';

	public function new(type:String, scopeOrVar:BaseVariablesReference) {
