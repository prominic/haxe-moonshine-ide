 ...
 */
interface ITryStatement extends IStatement extends IStatementContainer {
	 ...
	 */
	var catchClauses(get, never):Array<ICatchClause>;
	 ...
	 */
	var finallyClause(get, never):IFinallyClause;
