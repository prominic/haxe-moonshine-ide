...
@:final class PostfixOperator {
	...
	public static var POSTDEC(default, never):PostfixOperator = PostfixOperator.create('POSTDEC');

	public static var POSTINC(default, never):PostfixOperator = PostfixOperator.create('POSTINC');

	private static var intialized:Bool = false;
	 ...
	 * @private
	 */
	public function equals(other:PostfixOperator):Bool {
