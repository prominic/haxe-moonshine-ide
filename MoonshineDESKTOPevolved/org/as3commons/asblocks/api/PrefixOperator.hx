...
@:final class PrefixOperator {
	...
	public static var PREDEC(default, never):PrefixOperator = PrefixOperator.create('PREDEC');

	public static var PREINC(default, never):PrefixOperator = PrefixOperator.create('PREINC');
	 ...
	 * @private
	 */
	public function equals(other:PrefixOperator):Bool {
