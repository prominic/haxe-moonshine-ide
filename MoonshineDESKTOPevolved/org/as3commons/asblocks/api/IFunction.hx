...
interface IFunction {
	 ...
	 */
	var parameters(get, never):Array<IParameter>;
	 ...
	 * a parameter list.
	 */
	var hasParameters(get, never):Bool;

	/**
	 * @private
	 */
	var returnType(get, set):String;
	 ...
	 */
	var qualifiedReturnType(get, never):String;
	 ...
	 */
	function hasRestParameter():Bool;
