...
class ASFactory {
	 ...
	 */
	public function newNumberLiteral(number:Float):INumberLiteral {
	 ...
	 */
	public function newBooleanLiteral(boolean:Bool):IBooleanLiteral {
	...
	public function newInvocationExpression(target:IExpression,
			arguments:Array<IExpression>):IINvocationExpression {
		...
		result.arguments = cast arguments;
		return result;
	}
	...
	public function newNewExpression(target:IExpression,
			arguments:Array<IExpression> = null):INewExpression {
	...
	public function newDeclaration(declaration:String):IDeclarationStatement {
		...
		ast.parent = null;
		return AS3.as(StatementBuilder.build(ast), IDeclarationStatement);
	}
	 ...
	 * return The implemented <code>IASProject</code> project.
	 */
	private function createASProject():IASProject {
