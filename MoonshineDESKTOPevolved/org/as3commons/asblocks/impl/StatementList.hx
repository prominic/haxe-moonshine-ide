 ...
 * @productversion 1.0
 */
class StatementList extends ContainerDelegate implements IBlock {
	 ...
	 */
	override private function get_hasCode():Bool {
	 ...
	 */
	override private function get_statements():Array<IStatement> {
		var result:Array<IStatement> = new Array<IStatement>();
	...
	override public function newFor(initializer:IExpression,
		...
		var init:IParserNode = (initializer != null) ? initializer.node : null;
		var cond:IParserNode = (condition != null) ? condition.node : null;
		var iter:IParserNode = (iterator != null) ? iterator.node : null;
	...
	override public function newReturn(expression:IExpression = null):IReturnStatement {
		var result:IParserNode = ASTStatementBuilder.newReturn(((expression != null)) ? expression.node : null);
	 ...
	 * @private
	 */
	override public function newSuper(arguments:Array<IExpression> = null):ISuperStatement {
		var result:IParserNode = ASTStatementBuilder.newSuper(cast arguments);
		_addStatement(result);
