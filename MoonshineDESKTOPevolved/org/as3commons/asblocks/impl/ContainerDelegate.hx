 ...
 * @productversion 1.0
 */
class ContainerDelegate extends ScriptNode implements IStatementContainer {

	private var statementContainer(get, never):IStatementContainer;
	private function get_statementContainer():IStatementContainer {
		return null;
	}
	...
	private function get_statements():Array<IStatement> {
		return cast statementContainer.statements;
	}
	...
	public function newSuper(arguments:Array<IExpression> = null):ISuperStatement {
		return statementContainer.newSuper(cast arguments);
	}
