 ...
 * @productversion 1.0
 */
class VectorExpressionNode extends ExpressionNode implements IVectorExpression {
	 ...
	 */
	public var type(get, set):IExpression;
	private function get_type():IExpression {
	 ...
	 * @private
	 */
	private function set_type(value:IExpression):IExpression {
