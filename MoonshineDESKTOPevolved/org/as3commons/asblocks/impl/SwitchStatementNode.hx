 ...
 * @productversion 1.0
 */
class SwitchStatementNode extends ScriptNode implements ISwitchStatement {
	 ...
	 */
	public var labels(get, never):Array<ISwitchLabel>;
	private function get_labels():Array<ISwitchLabel> {
		var result:Array<ISwitchLabel> = new Array<ISwitchLabel>();
