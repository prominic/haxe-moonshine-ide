 ...
 * @productversion 1.0
 */
class ArrayLiteralNode extends LiteralNode implements IArrayLiteral {
	 ...
	 */
	public var entries(get, never):Array<IExpression>;
	private function get_entries():Array<IExpression> {
		var entries:Array<IExpression> = new Array<IExpression>();
