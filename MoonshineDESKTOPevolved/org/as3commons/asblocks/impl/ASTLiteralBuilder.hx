...
class ASTLiteralBuilder {
	 ...
	 * @private
	 */
	public static function newNumberLiteral(number:Float):IParserNode {
		return ASTBuilder.newAST(AS3NodeKind.NUMBER, Std.string(Std.string(number)));
	}
	 ...
	 * @private
	 */
	public static function newBooleanLiteral(boolean:Bool):IParserNode {
