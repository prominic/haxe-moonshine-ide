 ...
 * @productversion 1.0
 */
class ContentBlockNode extends ScriptNode implements IContentBlock {
	 ...
	 */
	public var methods(get, never):Array<IMethod>;
	private function get_methods():Array<IMethod> {
		var result:Array<IMethod> = new Array<IMethod>();
