...
class FieldUtil {
	...
	public static function getFields(ast:IParserNode):Array<IField> {
		var result:Array<IField> = new Array<IField>();
	...
	private static function containsField(ast:IParserNode, name:String):Bool {
		var i:ASTIterator = new ASTIterator(ast);
		while (i.hasNext()) {
			var member:IParserNode = i.next();
			if (member.isKind(AS3NodeKind.FIELD_LIST)) {
