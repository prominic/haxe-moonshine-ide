...
class KeyWords {
	...
	public static inline var INSTANCE_OF:String = 'instanceof';

	public static inline var INTERFACE:String = 'interface';

	public static inline var INTERNAL:String = 'internal';
	...
	public static inline var NAN:String = 'NaN';
	...
	public static inline var PROTECTED:String = 'protected';
