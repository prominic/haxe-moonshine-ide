...
class LinkedListTreeAdaptor {
	...
	public function createNode(payload:LinkedListToken):TokenNode {
		...
		} else if (payload.kind == Std.string((AS3NodeKind.ARRAY != null) ? AS3NodeKind.ARRAY : Std.string(payload.kind == AS3NodeKind.META)) /*|| payload.kind == AS3NodeKind.ARRAY_ACCESSOR*/ ) {
